...
public class ListadoTestP2 {
    ...
    */
   @Test
   public void testObtenerContadoresSectorRuta() throws Exception {
   ...
   public void testObtenerContadoresSector() throws Exception {
      // Se obtienen los contadores para todos los grupos
      List<Long> contadores = listado.obtenerContadoresSectores();
      Long Contadores[] = {1673L, 1640L, 1687L};
      //Corregir orden contadores//////////////////////////////////////////////////////////////////////////
      assertArrayEquals(contadores.toArray(), Contadores);
   }

   @Test
   public void testBuscarEmpleadosSinRuta(){

      int s1 = listado.buscarEmpleadosSinRuta(Sector.SECTOR1).size();
      int s2 = listado.buscarEmpleadosSinRuta(Sector.SECTOR2).size();
      int ns = listado.buscarEmpleadosSinRuta(Sector.NOSECTOR).size();
   ...
   @Test
   public void testBuscarEmpleadosConSectorSinRuta() {

       int numEmpleados = listado.buscarEmpleadosConSectorSinRuta().size();

       assert (numEmpleados == 831);
   }

   @Test
    public void testBuscarEmpleadosSinSectorConRuta() {

       int numEmpleados = listado.buscarEmpleadosSinSectorConRuta().size();

       assert (numEmpleados == 1269);

   }
   
   @Test
    public void testEquilibrarSectores(){

       listado.equilibrarSectores();
